...
# Generated by qmake (2.01a) (Qt 4.7.2) on: ?? ????? 25 17:26:07 2011
# Project:  kvn-table.pro
# Template: subdirs
# Command: /usr/local/Trolltech/Qt-4.7.2/bin/qmake -spec /usr/local/Trolltech/Qt-4.7.2/mkspecs/linux-g++ CONFIG+=debug -o Makefile kvn-table.pro
#############################################################################
...
src/$(MAKEFILE): 
	...
	cd src/ && $(QMAKE) /home/demihalf/qtProjects/kvn-table/src/src.pro -spec /usr/local/Trolltech/Qt-4.7.2/mkspecs/linux-g++ CONFIG+=debug -o $(MAKEFILE)
...
Makefile: kvn-table.pro  /usr/local/Trolltech/Qt-4.7.2/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.7.2/mkspecs/common/g++.conf \
	...
	$(QMAKE) -spec /usr/local/Trolltech/Qt-4.7.2/mkspecs/linux-g++ CONFIG+=debug -o Makefile kvn-table.pro
